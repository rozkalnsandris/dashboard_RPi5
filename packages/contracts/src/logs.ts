...
export const LogSourceIdSchema = Type.Union([
  ...
  Type.Literal("systemd:cloudflared"),
  Type.Literal("systemd:rpi5-monitor"),
  Type.Literal("systemd:rpi5-post-reboot"),
  Type.Literal("systemd:rpi5-tmp-headroom"),
  Type.Literal("systemd:rpi5-dashboard-evidence"),
  Type.Literal("systemd:hermes-tech-web"),
